...
public class CarController {
        ...
        public ResponseEntity<CarInfo> findCarInfo(
                        @Parameter(description = "ID of the car to retrieve", required = true) @PathVariable Integer carId) {
        ...
        public ResponseEntity<CarDetailedInfo> findCarDetailedInfo(
                        @Parameter(description = "ID of the car to retrieve detailed info", required = true) @PathVariable Integer carId) {
        ...
        public ResponseEntity<List<CarInfo>> findCarsInPriceRange(
                        @Parameter(description = "Minimum price (inclusive)", example = "10000", required = true) @RequestParam Integer from,
                        @Parameter(description = "Maximum price (inclusive)", example = "50000", required = true) @RequestParam Integer to) {
        ...
        public ResponseEntity<List<CarInfo>> findCarsInPriceRangeWithFuelType(
                        @Parameter(description = "Minimum price (inclusive)", example = "10000", required = true) @RequestParam Integer from,
                        @Parameter(description = "Maximum price (inclusive)", example = "50000", required = true) @RequestParam Integer to,
                        @Parameter(description = "Fuel type code (E, H, P)", example = "E", required = true) @RequestParam String fuelTypeCode) {
        ...
        public ResponseEntity<Void> updateCar(
                        @Parameter(description = "ID of the car to update", required = true) @PathVariable Integer carId,
                        @Valid @RequestBody CarDto carDto) {
        ...
        public ResponseEntity<Void> deleteCar(
                        @Parameter(description = "ID of the car to delete", required = true) @PathVariable Integer carId) {
